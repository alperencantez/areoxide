...
async fn test_drive() {
    ...
    match client.get_balance("0xdd0446989c851A76Bf03e10a04eae1488e58a0D9".to_string()).await {
        Ok(balance) => {
    ...
    match client.get_block_by_hash("0x67a384763b3b986363694c48b710c4a61d92e684ff65bc39ce3f843cc0ea35f2".to_string(), false).await {
    ...
    match client.chain_id().await {
        Ok(chain_id) => println!("Areon Chain ID: {:#?}", util::hexadecimal_str_to_decimal_str(chain_id).unwrap()),
